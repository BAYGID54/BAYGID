...
def Main():
	...
	if opt in ["B","2"]:
		admin()
	if opt in ["C","3"]:
		os.system('xdg-open https://https://www.facebook.com/md.baygid.1428?mibextid=ZbWKwL');time.sleep(1)
		fb()
	if opt in ["D","4"]:
...
def admin():
	...
	if bal =='2':
		...
		admin()
	if bal =='3':
		os.system('xdg-ope https://github.com/BAYGID54/BAYGID/blob/main/ami%20nai.txt');time.sleep(1)
		admin()
	if bal =='0':
		Main()
